...
--TABLA DE USUARIOS ATENCION ESTA TABLA NO ES DEL CATALOGO!!!
...
--PROCEDIMIENTO QUE RETORNA Id DEL USUARIO
...
insert into USERS (email, pass, admin) output inserted.id values ('test', 'test', 0)